...
/**
 * The PhotoReviewListPresenter.
 */
public class PhotoReviewListPresenter extends ListPresenter {

    private final InstagramContentConnector contentConnector;

    @Inject
    public PhotoReviewListPresenter(ListView view, ComponentProvider componentProvider, ContentConnector contentConnector) {
