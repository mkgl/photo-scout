...
/**
 * The PhotoCaptionColumnFormatter.
 */
public class PhotoCaptionColumnFormatter implements ColumnFormatter {
        ...
        if (item != null) {
            ...
            if (typeProperty != null) {
                ...
                if (type.equals("image")) {
                    text += String.format(ICON_TAG, "icon-file-image");
                } else if (type.equals("video")) {
                    text += String.format(ICON_TAG, "icon-file-video");
                }
            }

            Property<?> captionProperty = item.getItemProperty("caption.text");
            if (captionProperty != null) {
                text += (String) captionProperty.getValue();
            }
        }
